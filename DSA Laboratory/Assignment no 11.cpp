...
int main()
{
int i, n, ch, ch1, rec, start, count, add, n1, add2, start2, n2, y, a, b,
on, oname, add3, start3, n3, y1, add4, start4, n4;
...
case 7:
int roll;
cout << "Please Enter the Roll No. of Student Whose Info You
Want to Delete: ";
cin >> roll;
f.open("StuRecord.txt", ios::in);
...
cout << "The record with the roll no. " << roll << " has been
deleted " << endl;
f.close();
g.close();
